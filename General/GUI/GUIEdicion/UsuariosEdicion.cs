...
namespace General.GUI.GUIEdicion
{
    public partial class UsuariosEdicion : Form
    {
        ...
        private void UsuariosEdicion_Load(object sender, EventArgs e)
        {
            ...
            // Seleccionamos el primer item del ComboBox de roles, si existen items
            if (cbxRoles.Items.Count > 0)
            {
                cbxRoles.SelectedIndex = 0;  // Selecciona el primer item
                txtusuarioIDRol.Text = cbxRoles.SelectedValue.ToString();  // Asigna el ID del rol al TextBox
            }

            // Seleccionamos el primer item del ComboBox de empleados, si existen items
            if (cbxNombre.Items.Count > 0)
            {
                cbxNombre.SelectedIndex = 0;  // Selecciona el primer item
        ...
        private void txtusuarioIDRol_TextChanged(object sender, EventArgs e)
        {

        }

        private void cbxNombre_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void cbxRoles_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                // Asigna el ID del rol al TextBox correspondiente
