...
namespace General.GUI.GUIGestiones
{
    public partial class FacturaGestion : Form
    {
        ...
        private void Modificar_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                if (MessageBox.Show("Desea modificar esta Cuenta?", "Pregunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    f.txtIDConsulta.Text = dgvFactura.CurrentRow.Cells["Consulta_ID_Consulta"].Value.ToString();
                    f.Show();
        ...
        private void btnVistaPrevia_Click(object sender, EventArgs e)
        {
            ...
            VistaPreviaFactura vistaPreviaFactura = new VistaPreviaFactura();
            int idfactura = Convert.ToInt32(dgvFactura.CurrentRow.Cells["ID_Factura"].Value);
            vistaPreviaFactura.IdFactura = idfactura;

           // vistaPreviaFactura.lbsubtotal.Text = "$" + d.ObtenerTotal(idfactura).ToString();
            vistaPreviaFactura.lbNumeroFactura.Text = dgvFactura.CurrentRow.Cells["Fac_numeroFactura"].Value.ToString();
            vistaPreviaFactura.lbcliente.Text = dgvFactura.CurrentRow.Cells["NombrePaciente"].Value.ToString();
            vistaPreviaFactura.lbDoctor.Text = dgvFactura.CurrentRow.Cells["NombreDoctor"].Value.ToString();
            vistaPreviaFactura.lbMetodo.Text = dgvFactura.CurrentRow.Cells["Fac_MetodoPago"].Value.ToString();
            vistaPreviaFactura.lbFecha.Text = dgvFactura.CurrentRow.Cells["Fac_fecha"].Value.ToString();
            vistaPreviaFactura.lbPreciocons.Text = "$" + dgvFactura.CurrentRow.Cells["PrecioConsulta"].Value.ToString();
        ...
        private void FacturaGestion_Load_1(object sender, EventArgs e)
        {
            Cargar();
        }
