            ...
            try
            {
                ...
                if (dgvUsuarios.CurrentRow != null)
                {
                    if (MessageBox.Show("¿Desea modificar este usuario?", "Confirmación", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        f.txtUsuarioIDEmpleado.Text = dgvUsuarios.CurrentRow.Cells["Empleados_ID_Empleado"].Value.ToString();
                        f.txtusuarioIDRol.Text = dgvUsuarios.CurrentRow.Cells["Roles_ID_Rol"].Value.ToString();
