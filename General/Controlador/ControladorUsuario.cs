...
namespace General.Controlador
{
    internal class ControladorUsuarios
    {
        ...
        public static DataTable ListarEmpleados()
        {
            ...
            try
            {
                return operacion.ConsultarUsuario(query);  // Devuelve el DataTable con la lista de empleados
            }
            catch (Exception ex)
            {
        ...
        public DataTable ObtenerOpcionesDelRol(int idUsuario)
        {
            ...
            try
            {
                ...
                return operacion.ConsultarUsuario(query, parametros);  // Devuelve el DataTable con las opciones del rol
            }
            catch (Exception ex)
            {
